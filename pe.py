...
window = tk.Tk()
window.title('PE')
window.geometry("1420x770+50+20")
frame_ex = tk.Frame(window, bg='green')
frame_main = tk.Frame(window, bg='green')
frame_home = tk.Frame(window, bg='green')
frame_name = tk.Frame(window, bg='green')
frame_video = tk.Frame(window, bg='#000000')
# frame_video.pack(side=tk.BOTTOM, anchor=tk.S, expand=tk.YES, fill=tk.BOTH)
...
def sila():
    ...
    def sila_1():
        ...
        ex_name.config(font=('Courier', 20))
...
3 курс и старше: 
    ...
    def sila_5():
        ...
        ex_name = tk.Label(frame_name, text='пражнение N 48а марш-бросок на 5 км в составе подразделения')
        ex_name.config(font=('Courier', 20))
        ex_name.pack(fill='both')
...
'''
    ...
    botton_sila_10 = ttk.Button(frame_ex, text='Упражнение №58 плавание на 100 м способом брасс', command=sila_8).pack(fill='both')
...
def VP():
    ...
    def sila_1():
        ...
        ex_name.config(font=('Courier', 15))
        ex_name.pack(fill='both')
